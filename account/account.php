...
<main id="Account">
    ...
    <div id="yourAccount">
        <section class="accountSection">
            <img src="../image/box.png" id="box">
            <a href="../update_items/update_item"><?=$_TXT[41]?></a>
            <p class="smallerText"><?=$_TXT[42]?></p>
        </section>

        <section class="accountSection">
            <img src="../image/lock.png" id="box">
            <a href="../update_profile/update_profile"><?=$_TXT[43]?></a>
            <p class="smallerText"><?=$_TXT[44]?></p>
        </section>

        <section class="accountSection">
            <img src="../image/prime.png" id="box">
            <p><?=$_TXT[45]?></p>
            <p class="smallerText"><?=$_TXT[44]?></p>
        </section>

        <section class="accountSection">
            <img src="../image/address.png" id="box">
            <p><?=$_TXT[46]?></p>
            <p class="smallerText"><?=$_TXT[47]?></p>
        </section>
        <section class="accountSection">
            <img src="../image/card.png" id="box">
            <p><?=$_TXT[48]?></p>
            <p class="smallerText"><?=$_TXT[49]?></p>
        </section>
        <section class="accountSection">
            <img src="../image/gift_card.png" id="box">
            <p><?=$_TXT[50]?></p>
            <p class="smallerText"><?=$_TXT[51]?></p>
        </section>
